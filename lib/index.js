...
var SevenSegmentDisplay = function SevenSegmentDisplay(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      segmentMap.map(function (Segment, i) {
        return Segment({ key: i, x: segmentOffsetMap[i].x, y: segmentOffsetMap[i].y, className: digitToSegmentMap[props.digit][i] ? "led-segment-active" : "led-segment-inactive" });
      })
    )
  );
};
